        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($request->getPost())) {
                ...
                if ($checkemail == NULL and  $checkuser == NULL ) { 
                    ...
                    .$hostname.$this->view->translate('/en/user/validate/t/').$token.'<br /><br />'.
                    utf8_decode($this->view->translate('After validate this link you will be able to access with this data:')).'<br />'.
                    utf8_decode($this->view->translate('User name:')).$formulario['username'].'<br />'.
                  utf8_decode($this->view->translate('Password:')).$password);
