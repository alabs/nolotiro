...
public function getAdforSearch($id, $ad_type) {
	...
	public function getAdUserlist($id) {
                    ...
                    $query = "SELECT ads.user_owner,ads.type,ads.woeid_code,ads.id as ad_id,ads.title,ads.body, ads.type,ads.date_created, ads.status, users.username,users.id   FROM ads,users
